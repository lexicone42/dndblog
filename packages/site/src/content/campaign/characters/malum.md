...
- **STR:** -1 | **DEX:** +6 | **CON:** +1
- **INT:** +5 | **WIS:** +0 | **CHA:** +1
- Advantage against being charmed; magic can't put Mal to sleep
...
**Tools:** Darts, Disguise Kit, Poisoner's Kit, Thieves' Tools

**Languages:** Common, Elvish, Goblin, Thieves' Cant, Undercommon

## Equipment

- **Light Crossbow** — +6 to hit, 1d8+3 piercing, range 80/320
- **Daggers (2)** — +6 to hit, 1d4+3 piercing, range 20/60 (Nick mastery)
- **Scimitar** — +6 to hit, 1d6+3 slashing (Nick)
- **Shortbow** — +6 to hit, 1d6+3 piercing, range 80/320 (Vex)
- **Shortsword** — +6 to hit, 1d6+3 piercing (Vex)
